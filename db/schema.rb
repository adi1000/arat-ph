...
ActiveRecord::Schema[7.0].define(version: 2022_10_17_064826) do
  ...
  create_table "amenities", force: :cascade do |t|
    ...
    t.index ["supplier_id"], name: "index_amenities_on_supplier_id"
  end

  create_table "package_amenities", force: :cascade do |t|
    t.bigint "package_id"
    t.bigint "amenity_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
